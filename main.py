                ...
                if not page.logged_in and page.view == "LOGIN":
                    ...
                    def load_press_current_mold():
                        try:
                            ...
                            if res.data:
                                row = res.data[0]
                                o_m.value = row.get("mold_name", "") or ""
                                model_no.value = str(row.get("modele", "") or "")
                                matiere.value = str(row.get("matiere", "A018") or "A018")
                                mpa.value = str(row.get("mpa", "") or "")
                                cycle.value = str(row.get("cycle", "") or "")
                                temps.value = str(row.get("temps", "") or "")
                                info_txt.value = f"Moule sortant chargé: {o_m.value}" if o_m.value else "Aucun moule sortant enregistré."
                            else:
                                o_m.value = ""
                                model_no.value = ""
                                matiere.value = "A018"
                                ...
                                cycle.value = ""
                                temps.value = ""
                                info_txt.value = "Aucun moule enregistré pour cette presse."
