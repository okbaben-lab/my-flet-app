                ...
                if not page.logged_in and page.view == "LOGIN":
                            ...
                            [
                                ft.Row(
                                    [
                                        ft.Column(
                                            [
                                                ft.Text("VERSION: OKBA-2026-FULL-FIX", color="yellow", size=12),
                    ...
                    def save_i(e):
                        try:
                            ...
                            final_err_img_url = resolve_photo_source(page.photo_err_path, "errors")
                            final_sol_img_url = resolve_photo_source(page.photo_sol_path, "solutions")
