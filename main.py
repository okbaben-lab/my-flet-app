            ...
            try:
                ...
                if not page.logged_in and page.view == "LOGIN":
                            ...
                            [
                                ft.Row(
                                    [
                                        ft.Column(
                                            [
                                                ft.Text("VERSION: OKBA-2026-FINAL", color="yellow", size=12),
                    ...
                    screen = safe_screen(
                        ...
                        p_qty,
                        p_urg,
                        ft.ElevatedButton("ATTACHER PHOTO PIÈCE (GALERIE)", icon=ft.Icons.PHOTO_LIBRARY, on_click=pick_part_img),
                    ...
                    screen = safe_screen(
                        ...
                        ft.Column([
                            err_desc,
                            ft.ElevatedButton("ATTACHER PHOTO PROBLÈME (GALERIE)", icon=ft.Icons.PHOTO_LIBRARY, on_click=lambda e: pick_img("ERR"), bgcolor="red900"),
                            photo_err_manual,
                        ]),
                        ft.Column([
                            sol_desc,
                            ft.ElevatedButton("ATTACHER PHOTO SOLUTION (GALERIE)", icon=ft.Icons.PHOTO_LIBRARY, on_click=lambda e: pick_img("SOL"), bgcolor="green900"),
                            photo_sol_manual,
                        ]),
                        piec,
                        spare_price_in,
